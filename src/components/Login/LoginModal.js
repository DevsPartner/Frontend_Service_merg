...
export default function LoginModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex h-screen w-full overflow-hidden bg-white dark:bg-[#1c1e22]">
      {/* LEFT SIDE */}
        ...
        <div className="relative z-10 max-w-xl">
          <div className="mb-8">
            ...
            <p className="text-white/70 text-lg font-light leading-relaxed">
              The future of electronics, curated for you.
            </p>
          </div>
      ...
      <div className="w-full lg:w-2/5 flex items-center justify-center p-8 bg-gray-50 dark:bg-[#1c1e22]">
        <div className="w-full max-w-[440px] flex flex-col">
          ...
          <div className="mb-10">
            <h2 className="text-gray-900 dark:text-white text-3xl font-bold tracking-tight mb-2">
              Willkommen zurück
            </h2>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-500 dark:text-[#93a9c8] text-sm font-normal">
              Noch kein Konto?{" "}
              <Link href="/register" className="text-[#307de8] font-black hover:underline ml-1">
                Registrieren
              </Link>
            </p>
          </div>
