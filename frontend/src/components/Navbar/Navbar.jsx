                ...
                <>
                  ...
                  {user.isAdmin && (
                    <>
                      ...
                      <Link
                        href="/dashboard"
                        className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-teal-100 to-cyan-100 dark:from-teal-900/30 dark:to-cyan-900/30 text-teal-700 dark:text-teal-300 text-sm font-medium rounded-lg hover:shadow transition-all"
